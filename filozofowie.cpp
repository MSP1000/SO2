  ...
  public:
   int howlonghungry=0;
    ...
    void take_fork(int phnum)
    {
        ...
        cout << "Philosopher " << phnum << " is Eating, His hunger was "<<howlonghungry << endl;
         howlonghungry=0;
...
void *philosopher(void *arg){
    ...
    while (c < times)
    {
        ...
        phil_object.howlonghungry++;
        if(phil_object.howlonghungry>10){
            std::cout<<"FILOZOF UMARL Z GLODU!"<<std::endl;
            break;
        }
        sleep(0.5);
...
int main()
{
    ...
    for (int i = 0; i < N; i++)
    {
        pthread_create(&thread_id[i], &attr, philosopher, &Stoic[i]);
